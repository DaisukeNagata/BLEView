...
Collection_BLEのブランチは、iphone端末専用で、グラフを２端末描画表示できます。例えばipad用の電波強度グラフ、iphone用電波強度グラフで確認ができます。
...
The branch of Collection_BLE is dedicated to the iphone terminal, and the graph can be drawn and displayed on two terminals. For example, you can check with radio field intensity graph for ipad, radio field intensity graph for iphone.
